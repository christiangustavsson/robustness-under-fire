...
if __name__ == "__main__":
    ...
    kernel = C(0.1, constant_value_bounds="fixed") * RBF(length_scale=1, length_scale_bounds="fixed")
    ...
    with open('evaluation-1/results/e-1-GPR/tracker_effectiveness_all.pickle', 
                'wb') as file:
        pickle.dump(tracker_effectiveness_all, file)

    with open('evaluation-1/results/e-1-GPR/tracker_effectiveness_average.pickle', 
                'wb') as file:
